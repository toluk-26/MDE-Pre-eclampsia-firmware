...
#define UUID_CHR_DIASTOLIC "32610004-7bdb-4430-a1b9-e7d26fb2b981"
#define UUID_CHR_SYSTOLIC "32610005-7bdb-4430-a1b9-e7d26fb2b981"
#define UUID_CHR_DIASTOLIC_C "32610006-7bdb-4430-a1b9-e7d26fb2b981"
...
class ConfigService : public BLEService {
  ...
  protected:
    ...
    BLECharacteristic _diastolicCoefficients;  // diastolic m/b coefficients
    ...
    static void pid_cb(uint16_t conn_hdl, BLECharacteristic *chr, uint8_t *data,
                       uint16_t len);
    static void diastolic_cb(uint16_t conn_hdl, BLECharacteristic *chr,
                             uint8_t *data, uint16_t len);
    static void systolic_cb(uint16_t conn_hdl, BLECharacteristic *chr,
                            uint8_t *data, uint16_t len);
    static void diastolic_coefficient_cb(uint16_t conn_hdl, BLECharacteristic *chr,
                             uint8_t *data, uint16_t len);
    static void systolic_coefficient_cb(uint16_t conn_hdl, BLECharacteristic *chr,
                            uint8_t *data, uint16_t len);
};